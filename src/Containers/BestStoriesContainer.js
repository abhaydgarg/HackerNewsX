...
class BestStoriesContainer extends Component {
  ...
  componentDidMount () {
    console.log('BestStoriesContainer[MOUNTED]');
  }

  componentDidUpdate () {
    console.log('BestStoriesContainer[UPDATED]');
...
export default withStyles(styles)(BestStoriesContainer);
